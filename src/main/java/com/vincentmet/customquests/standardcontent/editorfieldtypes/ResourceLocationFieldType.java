...
public class ResourceLocationFieldType implements IEditorEntryDataType {
    private final ResourceLocation ID = new ResourceLocation(Ref.MODID, "resourcelocation");
