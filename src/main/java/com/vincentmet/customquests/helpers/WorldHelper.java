...
public class WorldHelper{
    public static boolean isPlayerInDimension(PlayerEntity player, ResourceLocation dimension){
        System.out.println("0- " + player.getEntityWorld().dimension.getType().getRegistryName());
        System.out.println("1- " + dimension);
        return player.getEntityWorld().dimension.getType().getRegistryName().equals(dimension);
    }
