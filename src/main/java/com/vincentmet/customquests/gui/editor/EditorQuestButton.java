...
public class EditorQuestButton implements ScrollableListEntry{
    ...
    public EditorQuestButton(IntSupplier x, IntSupplier y, IntSupplier width, Quest quest, Consumer<MouseButton> onClickCallback){
        this.x = x;
        this.y = y;
        this.width = width;
